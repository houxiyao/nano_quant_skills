...
from tushare_to_duckdb.tushare_duckdb_sync_scripts.common import SyncTask, bootstrap_project_path, log_event, period_to_duckdb_date, sql_placeholders

bootstrap_project_path()

from tushare_to_duckdb.tushare_duckdb_sync_scripts.etl.tushare_to_duckdb import (  # noqa: E402
    _parse_table_name,
    _qualified_name,
